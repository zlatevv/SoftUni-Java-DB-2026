...
public class ImportController extends BaseController {
    ...
    @Autowired
    public ImportController(StarService starService,
    ...
    public ModelAndView importAstronomers() throws IOException {
        String astronomersFileContent = this.astronomerService.readAstronomersFromFile();

        return super.view("json/import-astronomers", "astronomers", astronomersFileContent);
    }

    @PostMapping("/astronomers")
    public ModelAndView importAstronomersConfirm() throws IOException {
    ...
    @PostMapping("/stars")
    public ModelAndView importStarsConfirm() throws IOException {
